...
// the layer data flows through the registered buildQuery/transformProps of
// the sub-slice's viz type on the v1 chart data API
...
getChartTransformPropsRegistry().registerValue('deck_arc', () => ({
  payload: {
    data: {
...
getChartTransformPropsRegistry().registerValue('deck_scatter', () => ({
  payload: {
    data: {
      // The scatter sublayer query returns features tagged with a category
      // column.
      features: [
